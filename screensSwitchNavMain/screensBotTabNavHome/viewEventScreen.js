  ...
  render() {
    ...
    return (
      <SafeAreaProvider>
        ...
        <View style={[styles.eventItem, {borderBottomLeftRadius: 0, borderBottomRightRadius: 0}]}>
          ...
          {(() =>
            item.mine ? (
              <TouchableOpacity
                ...
                onPress={() => {
                  this.props.navigation.navigate("Create Event", {editing: item.id, eventInfo: JSON.parse(JSON.stringify(item))});
                }}
              >
        ...
        <View style={[styles.eventItem, { flexDirection: "column", borderTopRightRadius: 0, borderTopLeftRadius: 0 }]}>
